...
function categoryChange() {
    ...
    selection = document.getElementById("categorySelector");
    select_text = selection.options[selection.selectedIndex].text;
...
function initMainPage(dataArray) {
    ...
    // init scatter
    myBarVisOne = new BarVis('barDiv', dataArray[1], dataArray[2], true, 'Top', 'Cases (Absolute)');
    myBarVisTwo = new BarVis('barTwoDiv', dataArray[1], dataArray[2], false, 'Bottom', 'Cases (Absolute)');
